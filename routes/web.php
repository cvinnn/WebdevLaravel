...
Route::get('/contact', [ContactController::class, 'View'])->name('contact.form');;
...
Route::delete('/contact/delete/{name}', [ContactController::class, 'deleteContact'])->name('contact.delete');
